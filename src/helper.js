module.exports = {
    sanity(message) {
        message.channel.send(
            "Chris loves that you're so passionate about the server/city, but please remember he is the only developer of our community currently. He also has a fulltime job " +
    ...
    moreInfo(message) {
        ...
        message.channel.send(
            problemedUser +
                " - you have provided us with little to no information about the issue. Please provide some more in order for us to be able to help you out. "
        );
    },
    ...
    releaseInfo(message, adminRole, Discord) {
        ...
        const botId = message.guild.members.find(
